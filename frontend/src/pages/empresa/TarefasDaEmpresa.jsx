        ...
        <div className="min-h-screen text-white font-poppins p-4 space-y-6">
            ...
            <div className={cardClass}>
                ...
                <form onSubmit={criarTarefa} className="space-y-3">
                    <input type="text" placeholder="Descrição" value={novaTarefa.descricao}
                        onChange={(e) => setNovaTarefa({ ...novaTarefa, descricao: e.target.value })}
                        className={inputClass} required />

                    <input type="url" placeholder="Link" value={novaTarefa.link}
                        onChange={(e) => setNovaTarefa({ ...novaTarefa, link: e.target.value })}
                        className={inputClass} required />

                    <input type="number" placeholder="Desconto" value={novaTarefa.desconto}
                            ...
                            {editandoTarefaId === tarefa._id ? (
                                ...
                                <>
                                    ...
                                    <div className="flex gap-2 mt-4">
                                        ...
                                        <button onClick={() => excluirTarefa(tarefa._id)}
            ...
            {/* PRINTS */}
            <div>
                <h2 className="text-lg font-semibold mb-4">Prints recebidos</h2>

                <div className="space-y-3">
                    {prints.map((print) => (
                        <div key={print._id} className={`${cardClass} flex gap-4 items-center`}>
                            <img
